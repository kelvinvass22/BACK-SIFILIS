...
REST_FRAMEWORK = {
    ...
    # Adicione isso para garantir que o padrão permita acesso se a view mandar
...
SPECTACULAR_SETTINGS = {
    ...
    'DESCRIPTION': 'API para educação em saúde e teleorientação para idosos (TCC Kelvin)',
    'VERSION': '1.0.0',
    'SERVE_INCLUDE_SCHEMA': False,
    # Isso aqui agrupa os endpoints por App no Swagger:
...
TIME_ZONE = 'America/Fortaleza' # Já que você está no Ceará!
